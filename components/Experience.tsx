      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="space-y-12 border-l border-black/10 dark:border-white/10 pl-8">
              <motion.div
                ...
                className="relative"
              >
                <div className="absolute -left-[41px] top-1.5 h-4 w-4 rounded-full bg-black/20 dark:bg-white/20 border-2 border-gray-50 dark:border-[#121212]" />
                <h4 className="text-2xl font-semibold">Senior Graphic Designer | Team Leader</h4>
                <p className="mt-1 text-lg text-gray-600 dark:text-gray-400">Centurion Defence Academy</p>
                <p className="mb-4 text-sm text-gray-500 dark:text-gray-500">2025 – Present</p>
              ...
              >
                ...
                <p className="mt-1 text-lg text-gray-600 dark:text-gray-400">Centurion Defence Academy</p>
                <p className="mb-4 text-sm text-gray-500 dark:text-gray-500">Lucknow • 2024 – 2025</p>
                <ul className="list-disc space-y-2 pl-5 text-gray-700 dark:text-gray-300">
          ...
          <div>
            ...
            <div className="space-y-12 border-l border-black/10 dark:border-white/10 pl-8">
              ...
              >
                ...
                <p className="mt-1 text-lg text-gray-600 dark:text-gray-400">Wisdom College of Creativity & Design</p>
              ...
              >
                ...
                <p className="mt-1 text-lg text-gray-600 dark:text-gray-400">B.M Memorial College</p>
              ...
              >
                ...
                <p className="mt-1 text-lg text-gray-600 dark:text-gray-400">KPSSPP Inter College</p>
