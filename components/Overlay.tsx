        ...
        <AnimatePresence mode="wait">
          ...
          {activeSection === "tagline" && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -15 }}
              transition={{ duration: 1, ease: "easeInOut" }}
              className="absolute inset-0 flex flex-col items-start justify-center pl-0 text-left text-white md:pl-24"
            >
              ...
              <p className="max-w-2xl text-base tracking-wide text-gray-400 md:text-lg leading-relaxed">
